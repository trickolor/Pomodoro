...
import styles from '../../PointCount/pointcount.css';

export function TomatoSmile({ width = 115, height = 115 }: IIconPreset) {
    const isDark = useSelector<TCombinedState, boolean>(state => state.mode.isDark);

    return (
        <svg className={styles.tomatoSmile} width={width} height={height} viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="tomato 2" clipPath="url(#clip0_16_527)">
                <path id="Vector" d="M111.881 66.9398C111.881 96.9041 87.5898 115 57.6255 115C27.6603 115 3.36914 90.7089 3.36914 60.7437C3.36914 30.7794 28.4192 12.3571 58.3836 12.3571C88.3488 12.3571 111.881 36.9746 111.881 66.9398Z" fill={typeof window === 'object' && isDark ? '#30C1DD' : '#DC3E22'} />
                ...
                <path id="Vector_3" d="M58.9395 29.6396C58.9053 29.6396 58.8711 29.6388 58.8368 29.6379C56.7066 29.5826 55.0246 27.8121 55.0764 25.6835C55.0808 25.4993 55.2668 12.5386 48.067 6.90318C46.3877 5.58886 46.0911 3.16203 47.4054 1.48184C48.7206 -0.197465 51.1475 -0.49402 52.8268 0.821175C63.1229 8.87817 62.8158 25.1887 62.7982 25.8792C62.7429 27.9761 61.025 29.6396 58.9395 29.6396Z" fill="#A8B64F" />
                <circle id="Ellipse 2" cx="41.5" cy="64.5" r="2.5" fill="black" />
                <g id="Ellipse 4" filter="url(#filter0_f_16_527)">
                    <circle cx="29.5" cy="75.5" r="5.5" fill={typeof window === 'object' && isDark ? '#157676' : '#EA8979'} />
                </g>
                <g id="Ellipse 5" filter="url(#filter1_f_16_527)">
                    <circle cx="85.5" cy="75.5" r="5.5" fill={typeof window === 'object' && isDark ? '#157676' : '#EA8979'} />
                </g>
                <circle id="Ellipse 3" cx="73.5" cy="64.5" r="2.5" fill="black" />
                <path id="Vector 1" d="M46 78C50 82 64.5 83 68.5 78" stroke="black" />
            </g>
            <defs>
